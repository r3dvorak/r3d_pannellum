...
$moduleInventory = Get-VerifiedExtensionInventory -SourceDir $moduleDir -RequiredRoots @('mod_r3d_pannellum.xml','mod_r3d_pannellum.php','helper.php','fields','tmpl','forms','language','media/demo.jpg','media/viewer.js','media/viewer.css','media/reset-view.svg','media/pannellum/pannellum.js','media/pannellum/pannellum.css')
